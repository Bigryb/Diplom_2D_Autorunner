...
## Рекомендации для загрузки проекта на GitHub
...
Пример `.gitignore` для Unity можно взять из официального шаблона GitHub `Unity.gitignore` или создать вручную с исключением временных папок Unity.
